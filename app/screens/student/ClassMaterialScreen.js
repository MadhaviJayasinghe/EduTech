...
export default function ViewMaterialScreen({ navigation, route }) {
  ...
  const listFilesAndDirectories = (pageToken) => {
    const folder = route.params.data.teacherId + '/' + route.params.data.grade + '/'
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <PageLayout title='Class Materials' />
